...
Shader "Griffin/BuiltinRP/Foliage/GrassInteractive"
{
	Properties
	{
	...
	SubShader
	{
		...
		void vertexDataFunc( inout appdata_full v, out Input o )
		{
			...
			float4 _VertexPos3_g7 = ase_vertex4Pos;
			float4 transform12_g7 = mul(unity_ObjectToWorld,_VertexPos3_g7);
			float4x4 myLocalVar55_g7 = _WorldToNormalized;
			float4x4 _WorldToNormalized8_g7 = myLocalVar55_g7;
			float4 break28_g7 = mul( transform12_g7, _WorldToNormalized8_g7 );
			...
			float4 vertexOffset52_g7 = ( remappedBendVector44_g7 * v.color.a * _BendFactor51_g7 );
...
/*ASEBEGIN
Version=17700
7;14;1906;1005;3948.79;-1078.538;1.69238;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;8;-2168.615,-1464.77;Float;False;Property;_WaveDistance;Wave Distance;7;0;Create;True;0;0;False;0;0.1;0.2;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;70;-2153.813,-808.1543;Float;False;Property;_BendFactor;BendFactor;6;1;[HideInInspector];Create;True;0;0;False;0;1;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.TexturePropertyNode;80;-2192.371,-1718.896;Float;True;Property;_VectorField;VectorField;9;0;Create;True;0;0;False;0;None;None;False;gray;LockedToTexture2D;Texture2D;-1;0;1;SAMPLER2D;0
Node;AmplifyShaderEditor.Vector4Node;10;-2169.615,-1363.771;Float;False;Property;_Wind;Wind;8;0;Create;True;0;0;False;0;1,1,4,8;1,1,7,7;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.FunctionNode;109;-2208.612,2157.495;Inherit;False;GrassTouchBending;10;;7;de9a62c6bacea6b4888ce2cdd0a3d3f8;0;3;2;FLOAT4;0,0,0,0;False;4;SAMPLER2D;;False;50;FLOAT;1;False;1;FLOAT4;0
Node;AmplifyShaderEditor.TexturePropertyNode;6;-2190.384,-1929.848;Float;True;Property;_MainTex;MainTex;3;0;Create;True;0;0;False;0;None;None;False;white;LockedToTexture2D;Texture2D;-1;0;1;SAMPLER2D;0
...
Node;AmplifyShaderEditor.RangedFloatNode;17;-2263.971,-909.8423;Float;False;Property;_Occlusion;Occlusion;4;0;Create;True;0;0;False;0;0.2;0.2;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;15;-2263.971,-1012.744;Float;False;Property;_AlphaCutoff;Alpha Cutoff;5;0;Create;True;0;0;False;0;0.5;0.5;0;1;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=6DD82C4C5166D76725EA27B8086977E3F58204CC